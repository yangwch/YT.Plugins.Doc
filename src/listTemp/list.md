...
new Vue({
    components: {
        ...
        ElSelect: require('element-ui').Select,
        ElButton: require('element-ui').Button,
        ElForm: require('element-ui').Form,
        ElFormItem: require('element-ui').FormItem,
        ElInput: require('element-ui').Input,
        ElOption: require('element-ui').Option
    },
    data: {
        formInline: {
            user: '',
